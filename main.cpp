...
//    std::cout << "Hello, World!\n";
    Allocator allocator = Allocator::GetInstance("/Users/wingerted/test_shared_memory_dat", 100000, false);
...
//    };
    ...
    skiplist::LockFreeSkipList<int> list(shm_manager, false);
    list.Add(1);
    list.Add(2);
    list.Add(6);
    list.Add(5);
